...
- [ ] I followed [CONTRIBUTING.md](https://github.com/mwheiss/hydex-desktop/blob/main/CONTRIBUTING.md), kept the change focused, edited source files rather than generated output, and removed unrelated changes.
