...
DESKTOP_TEMPLATE="$REPO_DIR/packaging/appimage/hydex-desktop.desktop"
APPIMAGE_RUNTIME_TEMPLATE="$REPO_DIR/packaging/appimage/codex-appimage-runtime.sh"
PACKAGE_NAME="${PACKAGE_NAME:-hydex-desktop}"
PACKAGE_DISPLAY_NAME="${PACKAGE_DISPLAY_NAME:-Hydex Desktop}"
PACKAGE_COMMENT="${PACKAGE_COMMENT:-Hydex fork of Codex Desktop}"
